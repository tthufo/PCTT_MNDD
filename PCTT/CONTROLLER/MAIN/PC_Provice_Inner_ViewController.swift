...
extension PC_Provice_Inner_ViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       ...
       time.text = data.getValueFromKey("thoigian_capnhat")
        ...
        icon.image = UIImage(named: data.getValueFromKey("xuthe") == "1" ? "arrow_down" : "arrow_up")
        
        if data.getValueFromKey("xuthe") == "-1" {
            icon.imageColor(color: UIColor.systemGreen)
        }
...
//        red.alpha = data.getValueFromKey("cap_baodong") != "0" ? 0.7 : 0
        ...
        red.backgroundColor = UIColor.systemBlue
