...
//                        self.setUpLogin()
//                    }
                    LTRequest.sharedInstance()?.didRequestInfo(["absoluteLink":"https://dl.dropboxusercontent.com/s/iexun6o8d9g9m09/PCTT_WebView_MNDD_VER_1_2.plist", "overrideAlert":"1"], withCache: { (cache) in
...
//        self.navigationController?.pushViewController(AP_Map_ViewController.init(), animated: true)
    ...
    @IBAction func didPressSubmit() {
        ...
        LTRequest.sharedInstance()?.didRequestInfo(["CMD_CODE":"auth/login",
                                                    ...
                                                    "device_token":FirePush.shareInstance()?.deviceToken() ?? "",
                                                    "os_type":"ios",
                                                    "overrideAlert":"1",
                                                    "overrideLoading":"1",
                                                    "postFix":"auth/login",
