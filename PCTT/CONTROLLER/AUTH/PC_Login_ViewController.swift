...
//                        self.setUpLogin()
//                    }
                    LTRequest.sharedInstance()?.didRequestInfo(["absoluteLink":"https://dl.dropboxusercontent.com/s/8o3v919g4sfgwo7/PCTT_WebView_MNDD.plist", "overrideAlert":"1"], withCache: { (cache) in
